import type { OrientationEnum, ThemeModeEnum } from '../../../Core';
...
export type MediaQueryMatchers = {
  ...
  type?: MediaQueryType;
  direction?: 'rtl' | 'ltr';
  orientation?: OrientationEnum.Portrait | OrientationEnum.Landscape;
  prefersColorScheme?: ThemeModeEnum.Light | ThemeModeEnum.Dark;
};
